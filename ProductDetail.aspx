...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <%--<asp:FormView ID="ProductDetails" runat="server" ItemType="WingTipToys.Product" SelectMethod="GetProduct" RenderOuterTable ="false" >
        <ItemTemplate>
            <div>
            ...
            <table>
                <tr>
                    <td>
                        <img src="Images/Catalog/Images/<%#:Item.ImagePath%>" />
                    </td>
                </tr>
            </table>
        </ItemTemplate>
